                    ...
                    <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {features.map((f, idx) => {
                            return (
                                ...
                                >
                                    {/* Subtle Corner Glow */}
                                    <div className={`absolute -top-12 -right-12 w-24 h-24 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700`} />
                                    ...
                                    <div className={`absolute bottom-0 left-0 h-1 ${f.bgColor} w-0 group-hover:w-full transition-all duration-500`} />
                                </div>
                            )
                        })}
                    </div>
